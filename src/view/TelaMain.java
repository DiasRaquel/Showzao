...
public class TelaMain {
    ...
    public static void main(String[] args) {
        //List<Cidade> cidades = new ArrayList<Cidade>(); #Como era antes de ter o banco de dados
		...
		do{
			...
			switch (opcao) {
				...
				case 2:
					...
					if(cidades.size() == 0){
						JOptionPane.showMessageDialog(null, "É necessario cadastrar cidade primeiro.");
						cadastrarCidade();
				...
				case 4:
					if(categorias.size() == 0){
						JOptionPane.showMessageDialog(null, "É necessario cadastrar categoria primeiro.");
						categorias.add(cadastrarCategoria());
						produtos.add(cadastrarProduto(categorias));
					
					break;
				}else{produtos.add(cadastrarProduto(categorias));	
					break;
				}
	...
	public static void listarPedidos(List<Pedido> pedidos){
		...
		if(pedidos .size() == 0){
			...
			for (Pedido ped : pedidos) {
				...
				texto += "Pedido no end: " + ped.endereco ;
...
*/  
	...
	public static Produto cadastrarProduto(List<Categoria> categorias){
		...
		String qtdDigitado = JOptionPane.showInputDialog("Digite a quantidade: ");
		qtdDigitado = qtdDigitado.replace(",",".");
		double qtd = 0;
		if( !qtdDigitado.isEmpty()){
			qtd = Double.valueOf( qtdDigitado);
		}
	...
	public static void vizualizarPedido(List<Pedido> pedidos){
		...
		String texto = "";
		texto += "\n---------------------\n";
		texto += "\nID Do Pedido: " + pedSelecionado.id;
	...
	public static void excluirCidade(){
		...
		if( idDigitado.isEmpty()){
			JOptionPane.showMessageDialog(null, "Um id valido deve ser preenchido");
		}else{
